...
import 'package:alberca_9ids1/misClasesProfesorPage.dart';

class ProfesorPage extends StatelessWidget {
  final Usuario usuario;

  const ProfesorPage({super.key, required this.usuario});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Vista Profesor'),
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Desde aquí puedes revisar tus clases, administrar horarios, ver alumnos y generar reportes.',
              style: TextStyle(
                fontSize: 16,
                  ...
                  _buildMenuCard(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => MisClasesProfesorPage(profesorId: usuario.id),
                        ),
                      );
                    },
                  ),
